  ...
  render() {
    ...
    return (
      <div className="wrapper">
        ...
        <input type="text" className="operator display" id="calc-screen" placeholder="0" value={val} />
        ...
        <button type="button" className="operator operation" name="x" onClick={this.handleClick}>&times;</button>
